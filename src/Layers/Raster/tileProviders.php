<?php
/**
 * Free tile providers - from {@link https://github.com/leaflet-extras/leaflet-providers} Leaflet Providers
 *
 * Previews are at {@link https://leaflet-extras.github.io/leaflet-providers/preview/index.html}
 *
 * NOTE: In some cases limits apply to free use - check the provider for details
 *
 * NOTE: Some providers require registration; give the API Key/Access Token/... in TileProvider::providerOptions
 */
return [
    'OpenStreetMap' => [
    ...
    'TomTom' => [
        ...
        'options' => [
            ...
            'maxZoom' => 22,
            'attribution' =>
                '<a href="https://tomtom.com" target="_blank">&copy; 1992 - ' . date('Y') . 'TomTom.</a> ',
            'subdomains' => 'abcd',
            'style' => 'main',
            'ext' => 'png',
            'apikey' => '<insert your API key here>',
    ...
    'JusticeMap' => [
        ...
        'options' => [
            ...
            // one of 'county', 'tract', 'block'size: 'county',
